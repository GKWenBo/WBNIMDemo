...
//#import "NTESTeamMeetingVixewController.h"
...
//NTESTimerHolderDelegateNIMContactSelectDelegate
@interface NTESSessionViewController ()
<UIImagePickerControllerDelegate,
UINavigationControllerDelegate,
NIMSystemNotificationManagerDelegate,
NIMMediaManagerDelegate,
NIMEventSubscribeManagerDelegate,NTESTimerHolderDelegate>
...
- (void)onTapMediaItemSnapChat:(NIMMediaItem *)item
{
    ...
    if (isCamraAvailable) {
        ...
        sheet = [[UIActionSheet alloc] initWithTitle:@"请选择"
                                            delegate:nil
                                   cancelButtonTitle:@"取消"
                              destructiveButtonTitle:nil otherButtonTitles:@"从相册中选取",nil];
    }
    __weak typeof(self) wself = self;
 ...
 - (void)forwardMessage:(NIMMessage *)message toSession:(NIMSession *)session
{
    ...
    UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"确认转发"
                                                    message:tip
                                                   delegate:nil
                                          cancelButtonTitle:@"取消"
